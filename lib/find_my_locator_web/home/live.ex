defmodule FindMyLocatorWeb.Home.Live do
  @moduledoc false
  use Phoenix.LiveView, layout: {FindMyLocatorWeb.Layouts, :live}
  ...
  def render(assigns), do: FindMyLocatorWeb.Home.HTML.index_live(assigns)
