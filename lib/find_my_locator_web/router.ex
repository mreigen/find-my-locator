defmodule FindMyLocatorWeb.Router do
  use Phoenix.Router
  ...
  pipeline :browser do
    ...
    plug(:put_layout, {FindMyLocatorWeb.Layouts, :app})
    plug(:put_root_layout, {FindMyLocatorWeb.Layouts, :root})
  end
  ...
  defp session(conn, _opts) do
    opts = Plug.Session.init(FindMyLocatorWeb.Session.config())
