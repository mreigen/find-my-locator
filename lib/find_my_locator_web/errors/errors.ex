defmodule FindMyLocatorWeb.Errors do
  @moduledoc false
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(FindMyLocator.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(FindMyLocator.Gettext, "errors", message, options)
    end
  end
